                    ...
                    <div class="col-md-6">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form class="m-t-20" action="{{route('category.store')}}" method="post">
                                    @csrf
                                    <div class="">
                                        ...
                                        <div class="form-group">
                                            <input type="text" class="form-control" id="seo_title" name="seo_title" placeholder="Category Title Seo">
                                        </div>
                                        <div class="form-group">
                                            <textarea class="form-control" name="seo_description" rows="3" placeholder="Category Description Seo"></textarea>
                                        </div>

                                        <div class="form-group">
                                            <button class="btn btn-success waves-effect waves-light" type="submit">ایجاد
                                            </button>
                                        </div>
                                    </div>
                                </form>
