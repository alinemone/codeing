...
return [
    ...
    */
    ...
    'confirmed' => ':attribute  با فیلد تایید یکسان نیست.',
    ...
    */
    ...
    'attributes' => [
        ...
        'product_descriptions'=>'توضیحات محصول',
        'seo_title_fa'=>'عنوان سئو',
        'seo_title_en'=>'عنوان سئو',
        'seo_descriptions'=>'توضیحات سئو',
        'subcategories'=>'دسته بندی',
        'help'=>'راهنما',
        'support'=>'پشتیبانی',
        'browsers'=>'مرورگر های سازگار',
        'file_products'=>'فایل های همراه',
        'designs'=>'نوع طراحی',
        'creates'=>'ایجاد شده با',
        'demo_site'=>'لینک پیش نمایش',
        'tags'=>'تگ ها',
        'CashorFree'=>'وضعیت فروش',
        'selltype'=>'وضعیت فروش',
        'product_price'=>'قیمت محصول',
        'support_default'=>'پشتیبانی محصول',
        'comment'=>'دیدگاه',
    ],
